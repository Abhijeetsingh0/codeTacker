...
const newBlog = () => {
    ...
    useEffect(()=>{
        const regex = /@img\([^\)]+\)/;
        setContentSection(formData.content.split(regex))
        ...
        <div className="flex">
            ...
            <div className="basis-1/2 mt-28" >
                ...
                <div className='flex container'>
                    <div className='text-5xl text-emerald-500 basis-4/6'>
                        {String(formData.title).toUpperCase()}
                    </div>
                </div>
                
                <h1 className="text-2xl text-gray-600 px-4">Content: </h1>
                <div className='mt-12 mb-12 container'>
                    {contentSection && contentSection.map((content,index)=>(
                        (
                            <div key={index}>
                                <div className='text-2xl text-gray-700'> {content} </div>
